...
`engineering/milestones/phase-19-devtools.md` now maps those shipped PRs back to
`engineering/SPEC.md` §24.19, names the exact files and tests, records the full
...
flowchart TD
  ...
  Spec[engineering/SPEC.md section 24.19] --> Evidence
