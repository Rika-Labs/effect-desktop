...
The Phase 1 sub-issues had shipped, but the Phase 1 epic still lacked the durable milestone record required by `AGENTS.md` and `engineering/SPEC.md` §28.4. The goal was to close the phase without changing code by adding a factual completion document for the native host spike.
