...
|   #1829 Remove remaining native event side objects | Open   | Tracks the broader cleanup for empty and legacy event side objects after #1828 removes the touched ExecutionSandbox wrapper.                                    |
