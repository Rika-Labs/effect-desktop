...
- `bun prettier --check packages/native/src/window.ts packages/bridge/src/window.ts packages/native/src/index.test.ts packages/bridge/src/window.test.ts engineering/runs/issue-806-validate-window-create-chrome-inputs/05-scout.md engineering/runs/issue-806-validate-window-create-chrome-inputs/19-architect.md engineering/runs/issue-806-validate-window-create-chrome-inputs/20-review.md engineering/runs/issue-806-validate-window-create-chrome-inputs/21-work.md issues.json`
- `bun test`
- `cargo fmt --check`
