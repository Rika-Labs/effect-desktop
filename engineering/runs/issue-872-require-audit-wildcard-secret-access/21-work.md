...
- `bun run typecheck`
- `bun run lint`
- `bunx prettier --check packages/config/src/index.ts packages/config/src/index.test.ts engineering/runs/issue-872-require-audit-wildcard-secret-access/05-scout.md engineering/runs/issue-872-require-audit-wildcard-secret-access/19-architect.md engineering/runs/issue-872-require-audit-wildcard-secret-access/20-review.md engineering/runs/issue-872-require-audit-wildcard-secret-access/21-work.md`
- `bun run check`
- `bun run lint:types`
- `bun test`
