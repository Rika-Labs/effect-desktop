...
- `engineering/learnings/2026-05-06-logs-traces-metrics-panels.md` - prior intent says `DiagnosticsPanels` is a read-only projection over telemetry and should not invent diagnostics.
