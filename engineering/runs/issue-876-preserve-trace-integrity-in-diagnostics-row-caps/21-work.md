...
- `bun run lint:types`
- `bun test`
- `bunx prettier --check packages/devtools/src/diagnostics-panels.ts packages/devtools/src/index.test.ts engineering/runs/issue-876-preserve-trace-integrity-in-diagnostics-row-caps/05-scout.md engineering/runs/issue-876-preserve-trace-integrity-in-diagnostics-row-caps/19-architect.md engineering/runs/issue-876-preserve-trace-integrity-in-diagnostics-row-caps/20-review.md engineering/runs/issue-876-preserve-trace-integrity-in-diagnostics-row-caps/21-work.md issues.json`
