...
- `bun run typecheck`
- `bun run lint`
- `bunx prettier --check packages/core/src/runtime/event-log.ts packages/core/src/runtime/event-log.test.ts issues.json engineering/runs/issue-870-persist-eventlog-readonly-state/05-scout.md engineering/runs/issue-870-persist-eventlog-readonly-state/19-architect.md engineering/runs/issue-870-persist-eventlog-readonly-state/20-review.md engineering/runs/issue-870-persist-eventlog-readonly-state/21-work.md`
- `bun run check`
- `bun run lint:types`
- `bun test`
- `cargo fmt --check`
