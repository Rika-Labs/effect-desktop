...
- `engineering/learnings/2026-05-06-bun-desktop-package-artifacts.md` - packaging correctness requires validating the exact artifact and identity metadata downstream stages consume.
