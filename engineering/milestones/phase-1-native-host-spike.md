...
Tracks `engineering/SPEC.md` §24.1 and GitHub issue #3. Format follows the repo milestone convention and includes the §28.4 completion report.
...
- `engineering/security/exemptions/2026-05-04-host-wry-gtk-stack.md` for the WRY/TAO GTK advisory acceptance and re-review triggers.
