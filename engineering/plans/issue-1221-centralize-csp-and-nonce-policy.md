...
5. Make `packages/native/src/app-http-server.ts` render CSP headers through `@orika/config`, mint nonces from cryptographic entropy, and replace regex rewriting with Bun `HTMLRewriter`.
