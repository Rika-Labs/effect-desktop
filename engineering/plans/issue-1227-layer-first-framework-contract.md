...
What must remain true: `engineering/SPEC.md` remains normative, scope stays limited to #1227, and this ticket must not refactor every existing runtime service.
...
- `engineering/architecture/layer-first-contract.md` — new canonical contract and review checklist.
...
- The docs do not invent a second source of truth over `engineering/SPEC.md`; they extract a checklist from it.
