...
For every ticket, inspect the touched area for adapters, thin wrapper layers, custom DSLs, or parallel abstractions over Effect. If the wrapper is not adding durable desktop-specific semantics, remove it as part of the current work.
