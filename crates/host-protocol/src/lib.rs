...
pub const MENU_BIND_COMMAND_METHOD: &str = "Menu.bindCommand";
...
pub const CONTEXT_MENU_BUILD_FROM_TEMPLATE_METHOD: &str = "ContextMenu.buildFromTemplate";
pub const CONTEXT_MENU_BIND_COMMAND_METHOD: &str = "ContextMenu.bindCommand";
...
pub const WEBVIEW_CAPTURE_SCREENSHOT_METHOD: &str = "WebView.captureScreenshot";
pub const WEBVIEW_PRINT_METHOD: &str = "WebView.print";
pub const WEBVIEW_PRINT_TO_PDF_METHOD: &str = "WebView.printToPdf";
pub const WEBVIEW_FIND_IN_PAGE_METHOD: &str = "WebView.findInPage";
pub const WEBVIEW_SET_ZOOM_METHOD: &str = "WebView.setZoom";
pub const WEBVIEW_SET_USER_AGENT_METHOD: &str = "WebView.setUserAgent";
pub const WEBVIEW_SET_AUDIO_MUTED_METHOD: &str = "WebView.setAudioMuted";
pub const WEBVIEW_RESPOND_TO_PERMISSION_METHOD: &str = "WebView.respondToPermission";
pub const WEBVIEW_LIST_FRAMES_METHOD: &str = "WebView.listFrames";
pub const WEBVIEW_POST_TO_FRAME_METHOD: &str = "WebView.postToFrame";
...
pub const WEBVIEW_ATTACH_DEBUGGER_METHOD: &str = "WebView.attachDebugger";
