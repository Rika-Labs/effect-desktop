...
| #1292 Remove BridgeRpc once Effect RPC owns renderer contracts         | Removes the remaining custom contract DSL over Effect RPC.                        | Lets bridge keep only durable native/web protocol annotations and lowering utilities.                                     |
