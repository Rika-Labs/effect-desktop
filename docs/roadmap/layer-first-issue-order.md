...
| #1299 Own worker exit observers with scopes                            | Removes the remaining detached worker exit observer.                              | Completes the worker lifecycle cleanup after #1160 by making worker self-exit cleanup scoped like Process and PTY.        |
