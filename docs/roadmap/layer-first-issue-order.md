...
| #1297 Remove remaining BridgeRpc contract adapter                      | Removes the temporary BridgeRpc shim over Effect RpcGroup contracts.              | Completes the contract migration by deriving bridge descriptors directly from Effect RpcGroup metadata.                   |
