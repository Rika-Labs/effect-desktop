...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| #1264 Replace BridgeRpc runtime DSL with Effect RPC adapters           | Removes the remaining bridge-specific runtime DSL now that `RpcGroup` owns contracts. | Simplifies #1193, #1179, and later permission/middleware work by routing runtime calls through Effect RPC protocol adapters. |
