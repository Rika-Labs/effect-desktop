...
- `api/snapshots/@effect-desktop__native.snapshot.json` — record the intentional root surface
  reduction.
- `docs/roadmap/layer-first-issue-order.md` — record completion progress for #1205, #1178, and
  #1219.
- `docs/plans/issue-1219-narrow-native-public-root-export.md` — record scope and verification.
