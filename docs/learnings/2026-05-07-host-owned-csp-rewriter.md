...
supersedes: docs/learnings/2026-05-05-vite-compatible-build-pipeline.md
...
2. The migration scope listed only the playground; `templates/basic-react-tailwind` was a second consumer of the placeholder and `docs/SPEC.md` committed to the placeholder contract. Both are updated in this PR.
