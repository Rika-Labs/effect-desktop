...
- `bun run lint`
- `bun run lint:types`
- `bunx prettier --check packages/native/src/contracts/dock.ts packages/native/src/index.test.ts docs/runs/issue-814-validate-dock-badge-text/05-architect.md docs/runs/issue-814-validate-dock-badge-text/19-review.md issues.json api/snapshots/@effect-desktop__native.snapshot.json`
- `bun run check`
- `bun test`
