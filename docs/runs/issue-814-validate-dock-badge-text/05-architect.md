...
- `docs/SPEC.md` §11.20 / Appendix K — `Dock.setBadgeText(text: string | null)` is macOS-only; unsupported platforms model failure as typed values.
- `docs/learnings/2026-05-08-validate-dialog-native-ui-text-fields.md` — schema changes inside exported `Schema.Class` declarations require API snapshot verification.
