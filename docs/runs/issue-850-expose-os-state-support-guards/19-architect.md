...
- `docs/SPEC.md` §11.0 and Appendix K require `<Primitive>.isSupported(method)` before partial or unsupported rows.
...
- `docs/learnings/2026-05-06-linux-polish-capability-probes.md` warns that support probes are source-of-truth code and must not leak one platform's environment facts globally.
