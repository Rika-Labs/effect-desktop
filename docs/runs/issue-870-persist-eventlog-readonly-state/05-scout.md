...
- `docs/learnings/2026-05-06-eventlog-service-retention-ring.md` — EventLog must transition into read-only state on `SQLITE_FULL`; returning a single typed error is insufficient.
