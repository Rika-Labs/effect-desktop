...
- `bun prettier --check packages/cli/src/package-pipeline.ts packages/cli/src/index.test.ts docs/runs/issue-877-stage-macos-app-bundle-for-dmg-and-zip-packaging/05-scout.md docs/runs/issue-877-stage-macos-app-bundle-for-dmg-and-zip-packaging/19-architect.md docs/runs/issue-877-stage-macos-app-bundle-for-dmg-and-zip-packaging/20-review.md issues.json`
