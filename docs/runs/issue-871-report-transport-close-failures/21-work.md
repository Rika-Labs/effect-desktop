...
- `bun run typecheck`
- `bunx prettier --check packages/core/src/runtime/transport.ts packages/core/src/runtime/transport.test.ts docs/runs/issue-871-report-transport-close-failures/05-scout.md docs/runs/issue-871-report-transport-close-failures/19-architect.md docs/runs/issue-871-report-transport-close-failures/20-review.md issues.json`
- `bun run lint`
- `bun run check`
- `bun run lint:types`
- `bun test`
