...
| Spec                   | present        | `docs/SPEC.md` §23.4 and Appendix C.53/C.54 define truncation, atomic commit, stale notarization, and restart behavior. |
| Architecture           | present        | `docs/runs/issue-89-install-staging/05-architect.md`.                                                                   |
