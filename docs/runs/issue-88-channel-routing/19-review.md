...
| Spec                   | present        | `docs/SPEC.md` §16.1, §16.2, §23.4, Appendix C.52 define update config and downgrade refusal. |
| Architecture           | present        | `docs/runs/issue-88-channel-routing/05-architect.md`.                                         |
