...
| Maintainability   | `docs/runs/issue-88-channel-routing/25-pr.md:26` closes the outer PR-body fence before `Closes #88` and leaves an extra closing fence at line 51.                                           | must-fix | Workflow artifacts are the durable handoff record | Keep the full PR body inside one outer fence and remove the trailing stray fence. |
...
| ------------------------------------------------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/runs/issue-88-channel-routing/25-pr.md:26` | must-fix | This fenced block closes before `Closes #88`, then leaves a stray closing fence at line 51, so the run artifact does not accurately record the PR body. |
