...
- `bunx prettier --check docs/runs/issue-770-desktop-entrypoint/05-architect.md docs/runs/issue-770-desktop-entrypoint/19-review.md templates/basic-react-tailwind/src/template.test.ts tests/repo-shape.test.ts package.json templates/basic-react-tailwind/package.json issues.json` - passed.
