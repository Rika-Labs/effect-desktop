...
- `docs/SPEC.md` §11 and Appendix K require `Window.setVibrancy`, Dock badge/text/menu/attention, and application/window menus on macOS.
...
- `docs/SPEC.md` §4206/§4251-4253 names `windows.defaults.titleBarStyle`, `vibrancy`, and `trafficLights`; Appendix K names the macOS-only support matrix.
