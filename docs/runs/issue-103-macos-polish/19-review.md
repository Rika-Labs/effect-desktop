...
- `docs/learnings/2026-05-07-platform-polish-hooks-are-not-launch-gates.md` applies: optional polish cannot gate launch unless the missing behavior is a core invariant, and non-fatal polish must not skip independent work.
