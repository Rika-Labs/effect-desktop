...
- [ActivationRegistry](native/activation-registry.md) · [App](native/app.md) · [AppMetadata](native/app-metadata.md) · [Association](native/association.md) · [AttachmentIntake](native/attachment-intake.md) · [Autostart](native/autostart.md) · [BrowsingData](native/browsing-data.md) · [Clipboard](native/clipboard.md) · [ContextMenu](native/context-menu.md) · [CookieStore](native/cookie-store.md) · [CrashReporter](native/crash-reporter.md) · [DiagnosticsBundle](native/diagnostics-bundle.md) · [DisplayCapture](native/display-capture.md) · [Dialog](native/dialog.md)
- [DistributionParity](native/distribution-parity.md) · [Dock](native/dock.md) · [Download](native/download.md) · [EgressPolicy](native/egress-policy.md) · [ExecutionSandbox](native/execution-sandbox.md) · [ExtensionConfig](native/extension-config.md) · [ExtensionPackage](native/extension-package.md) · [FocusedApplicationContext](native/focused-application-context.md) · [GlobalShortcut](native/global-shortcut.md) · [Job](native/job.md) · [LocalToolRuntime](native/local-tool-runtime.md) · [Menu](native/menu.md) · [NativeFileSystem](native/native-file-system.md) · [NativeNetwork](native/native-network.md) · [NetworkAuth](native/network-auth.md) · [Notification](native/notification.md) · [Path](native/path.md)
- [PowerMonitor](native/power-monitor.md) · [Protocol](native/protocol.md) · [RealtimeMediaSession](native/realtime-media-session.md) · [RecentDocuments](native/recent-documents.md) · [ResidentLifecycle](native/resident-lifecycle.md) · [SafeStorage](native/safe-storage.md) · [ScopedAccessGrant](native/scoped-access-grant.md) · [Screen](native/screen.md) · [SelectionContext](native/selection-context.md) · [SessionPermission](native/session-permission.md) · [SessionProfile](native/session-profile.md) · [Shell](native/shell.md)
- [SystemAppearance](native/system-appearance.md) · [TransactionalFileMutation](native/transactional-file-mutation.md) · [TransientWindowRole](native/transient-window-role.md) · [Tray](native/tray.md) · [Updater](native/updater.md) · [WebRequest](native/web-request.md) · [WebView](native/webview.md) · [Window](native/window.md) · [WindowPersistence](native/window-persistence.md) · [WorkspaceIndex](native/workspace-index.md)
