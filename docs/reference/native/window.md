...
commands, general window transparency controls, vibrancy clearing, or a complete
platform support matrix for those chrome features. `setShadow` mutates the macOS
