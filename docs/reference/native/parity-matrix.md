...
- Total declared native methods: 220
- Routed by the Rust host: 198
...
| `AppMetadata`               | `getInfo`                   | `unsupported` | `AppMetadata.getInfo`                     | `routed`    |
| `AppMetadata`               | `getLaunchContext`          | `unsupported` | `AppMetadata.getLaunchContext`            | `routed`    |
| `AppMetadata`               | `getPaths`                  | `unsupported` | `AppMetadata.getPaths`                    | `routed`    |
