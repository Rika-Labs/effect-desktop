...
| `Window`                    | `getState`                  | `partial`     | `Window.getState`                         | `routed`    |
| `Window`                    | `hide`                      | `supported`   | `Window.hide`                             | `routed`    |
| `Window`                    | `list`                      | `supported`   | `Window.list`                             | `routed`    |
| `Window`                    | `maximize`                  | `partial`     | `Window.maximize`                         | `routed`    |
| `Window`                    | `minimize`                  | `partial`     | `Window.minimize`                         | `routed`    |
| `Window`                    | `requestAttention`          | `supported`   | `Window.requestAttention`                 | `routed`    |
| `Window`                    | `restore`                   | `partial`     | `Window.restore`                          | `routed`    |
...
| `Window`                    | `setFullscreen`             | `partial`     | `Window.setFullscreen`                    | `routed`    |
