...
- Routed by the Rust host: 195
- Missing from the Rust host dispatch registry: 25
...
| `Window`                    | `getById`                   | `partial`     | `Window.getById`                          | `missing`   |
| `Window`                    | `getCurrent`                | `partial`     | `Window.getCurrent`                       | `missing`   |
| `Window`                    | `getState`                  | `supported`   | `Window.getState`                         | `routed`    |
| `Window`                    | `hide`                      | `supported`   | `Window.hide`                             | `routed`    |
| `Window`                    | `list`                      | `partial`     | `Window.list`                             | `missing`   |
