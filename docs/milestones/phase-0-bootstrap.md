...
Tracks `docs/SPEC.md` §24.0 (Phase 0). Format follows §A.3.
...
- `docs/SPEC.md` (renamed from repo root), `docs/decisions/adr-0000-template.md`, `docs/architecture/`, `docs/milestones/`, `docs/validation/`.
...
Documented in `docs/SPEC.md` §26 — none specific to Phase 0.
...
- the project-memory `effect-v4-baseline.md` was updated to reference `docs/SPEC.md` (the post-rename path).
