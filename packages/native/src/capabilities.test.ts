...
const WindowVibrancyMacosOnlySupport = {
  status: "partial",
...
const WindowShadowMacosOnlySupport = {
  status: "partial",
...
const WindowTitleBarStyleMacosOnlySupport = {
  status: "partial",
...
const WindowTransparentMacosOnlySupport = {
  status: "partial",
...
test("NativeCapabilities exposes support metadata from native surfaces", () => {
  ...
  return runtime.runPromise(
    Effect.gen(function* () {
      ...
      const windowSetTransparent = yield* capabilities.support("Window.setTransparent")
      ...
      expect(windowSetTransparent).toEqual(WindowTransparentMacosOnlySupport)
