...
export const DOCK_SET_JUMP_LIST_METHOD = "Dock.setJumpList"
...
export const MENU_BIND_COMMAND_METHOD = "Menu.bindCommand"
export const MENU_CAPABILITY_METHOD = "Menu.capability"
export const MENU_ACTIVATED_EVENT_METHOD = "Menu.Activated"
export const CONTEXT_MENU_SHOW_METHOD = "ContextMenu.show"
export const CONTEXT_MENU_BUILD_FROM_TEMPLATE_METHOD = "ContextMenu.buildFromTemplate"
export const CONTEXT_MENU_BIND_COMMAND_METHOD = "ContextMenu.bindCommand"
...
export const WEBVIEW_CAPTURE_SCREENSHOT_METHOD = "WebView.captureScreenshot"
export const WEBVIEW_PRINT_METHOD = "WebView.print"
export const WEBVIEW_PRINT_TO_PDF_METHOD = "WebView.printToPdf"
export const WEBVIEW_FIND_IN_PAGE_METHOD = "WebView.findInPage"
export const WEBVIEW_SET_ZOOM_METHOD = "WebView.setZoom"
export const WEBVIEW_SET_USER_AGENT_METHOD = "WebView.setUserAgent"
export const WEBVIEW_SET_AUDIO_MUTED_METHOD = "WebView.setAudioMuted"
export const WEBVIEW_RESPOND_TO_PERMISSION_METHOD = "WebView.respondToPermission"
export const WEBVIEW_LIST_FRAMES_METHOD = "WebView.listFrames"
export const WEBVIEW_POST_TO_FRAME_METHOD = "WebView.postToFrame"
...
export const WEBVIEW_ATTACH_DEBUGGER_METHOD = "WebView.attachDebugger"
export const WEBVIEW_SET_NAVIGATION_POLICY_METHOD = "WebView.setNavigationPolicy"
export const WEBVIEW_CAPABILITY_METHOD = "WebView.capability"
...
export const SESSION_PROFILE_FROM_PARTITION_METHOD = "SessionProfile.fromPartition"
export const SESSION_PROFILE_DESTROY_METHOD = "SessionProfile.destroy"
export const SESSION_PROFILE_LIST_METHOD = "SessionProfile.list"
...
export const COOKIE_STORE_GET_METHOD = "CookieStore.get"
export const COOKIE_STORE_SET_METHOD = "CookieStore.set"
export const COOKIE_STORE_REMOVE_METHOD = "CookieStore.remove"
...
export const BROWSING_DATA_CLEAR_METHOD = "BrowsingData.clear"
export const BROWSING_DATA_ESTIMATE_METHOD = "BrowsingData.estimate"
export const BROWSING_DATA_LIST_TYPES_METHOD = "BrowsingData.listTypes"
...
export const SESSION_PERMISSION_REQUEST_METHOD = "SessionPermission.request"
export const SESSION_PERMISSION_DECIDE_METHOD = "SessionPermission.decide"
export const SESSION_PERMISSION_LIST_DECISIONS_METHOD = "SessionPermission.listDecisions"
...
export const DOWNLOAD_START_METHOD = "Download.start"
export const DOWNLOAD_PAUSE_METHOD = "Download.pause"
export const DOWNLOAD_RESUME_METHOD = "Download.resume"
export const DOWNLOAD_CANCEL_METHOD = "Download.cancel"
export const DOWNLOAD_LIST_METHOD = "Download.list"
...
export const NETWORK_AUTH_HANDLE_AUTH_METHOD = "NetworkAuth.handleAuth"
export const NETWORK_AUTH_HANDLE_CERTIFICATE_METHOD = "NetworkAuth.handleCertificate"
...
export const WEB_REQUEST_ON_BEFORE_REQUEST_METHOD = "WebRequest.onBeforeRequest"
export const WEB_REQUEST_ON_HEADERS_RECEIVED_METHOD = "WebRequest.onHeadersReceived"
export const WEB_REQUEST_REMOVE_LISTENER_METHOD = "WebRequest.removeListener"
...
export const NATIVE_NETWORK_FETCH_METHOD = "NativeNetwork.fetch"
export const NATIVE_NETWORK_UPLOAD_METHOD = "NativeNetwork.upload"
export const NATIVE_NETWORK_CONNECT_WEB_SOCKET_METHOD = "NativeNetwork.connectWebSocket"
export const NATIVE_NETWORK_CLOSE_WEB_SOCKET_METHOD = "NativeNetwork.closeWebSocket"
export const NATIVE_NETWORK_LOCALHOST_URL_METHOD = "NativeNetwork.localhostUrl"
