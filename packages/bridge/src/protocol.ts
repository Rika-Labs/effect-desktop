...
export const PTY_OPEN_METHOD = "Pty.open"
export const PTY_READ_METHOD = "Pty.read"
export const PTY_WRITE_METHOD = "Pty.write"
export const PTY_RESIZE_METHOD = "Pty.resize"
export const PTY_KILL_METHOD = "Pty.kill"
export const PTY_TERMINATE_TREE_METHOD = "Pty.terminateTree"
export const PTY_FORCE_KILL_TREE_METHOD = "Pty.forceKillTree"
export const PTY_WAIT_METHOD = "Pty.wait"
export const PTY_DISPOSE_METHOD = "Pty.dispose"
